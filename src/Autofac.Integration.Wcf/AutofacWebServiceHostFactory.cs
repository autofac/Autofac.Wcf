...
{
    /// <summary>
    /// Creates a <see cref="WebServiceHost"/> for a specified type of service
    ...
    /// </param>
    /// <returns>
    /// A <see cref="WebServiceHost"/> for the type of service specified
    /// with a specific base address.
    /// </returns>
    ...
    /// <summary>
    /// Creates a <see cref="WebServiceHost"/> for a singleton service instance
    /// with a specific base address.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// A <see cref="WebServiceHost"/> for the singleton service instance
